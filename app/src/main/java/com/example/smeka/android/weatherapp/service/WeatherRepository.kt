...
import com.example.smeka.android.weatherapp.BuildConfig
...
class WeatherRepository @Inject constructor(
    ...
    fun getCurrentWeatherByCity(city: String): Flow<CurrentWeather> = flow {
        val response = service.getCurrentWeatherByCity(city, BuildConfig.API_KEY)
